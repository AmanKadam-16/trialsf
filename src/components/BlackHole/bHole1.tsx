...
useEffect(()=>{
    ...
    function blackhole(element) {
        ...
        var star = function(){
            ...
            stars.push(this);
            this.color = 'rgba(0,0,0,'+ (1 - ((this.orbital) / 255)) +')'; // Color the star white, but make it more transparent the further out it is generated
        ...
        function loop(){
            ...
            context.fillStyle = 'rgba(247.04, 245.92, 242.56, 0.2)';   // somewhat clear the context, this way there will be trails behind the stars 
        ...
        function init(time){
            context.fillStyle = 'rgba(247.04, 245.92, 242.56, 1)';  // Initial clear of the canvas, to avoid an issue where it all gets too dark
            context.fillRect(0, 0, cw, ch);
