  ...
  const handleButtonClick = async () => {
    ...
    try {
      const stream = await openai.chat.completions.create({
        messages: [
          { role: 'system', content: 'You are only an AI Code Documentor And Respond to questions only if they ask you to document any Code and cheerfully deny such questions.If your response contains code blocks then provide the generated code within Markdown code blocks, specifying the language (e.g., ```javascript or ```python).' },
