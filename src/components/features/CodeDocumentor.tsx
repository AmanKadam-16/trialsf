  ...
  const handleButtonClick = async () => {
    ...
    try {
      const stream = await openai.chat.completions.create({
        messages: [
          { role: 'system', content: 'You are an AI Code Documentor.If your response contains code blocks then provide the generated code within Markdown code blocks, specifying the language (e.g., ```javascript or ```python).' },
